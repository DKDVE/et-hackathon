...
Next steps:
  ...
  2. Seed ingest:     az containerapp job update -g ${AZURE_RESOURCE_GROUP} -n ${AZURE_SEED_JOB} --set-env-vars SEED_PHASE=ingest && az containerapp job start -g ${AZURE_RESOURCE_GROUP} -n ${AZURE_SEED_JOB}
